...
import { ShieldCheck, LayoutDashboard, LogOut, User, Menu, X } from 'lucide-react';
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <div className="dropdown dropdown-end">
              <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar border border-base-300">
                <div className="w-9 rounded-full bg-info/10 flex items-center justify-center">
              ...
              >
                <div className="px-4 py-2 border-b border-base-200 mb-2">
                  <p className="font-bold text-xs opacity-50 uppercase tracking-wider">Admin Panel</p>
                </div>
                <li>
            ...
            <div className="p-4 space-y-4">
              <div className="flex items-center gap-3 p-3 bg-base-200/50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs opacity-60 italic text-info">Full Access Granted</p>
                </div>
              </div>
